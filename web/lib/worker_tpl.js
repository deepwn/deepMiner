...
STATICTOP = STATIC_BASE + 12688;
__ATINIT__.push();
var STATIC_BUMP = 12688;
...
var real__cryptonight_hash = asm["_cryptonight_hash"];
asm["_cryptonight_hash"] = function() {
    assert(runtimeInitialized, "you need to wait for the runtime to be ready (e.g. wait for main() to be called)");
    assert(!runtimeExited, "the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)");
...
CryptonightWASMWrapper.prototype.hash = function(input, output, length) {
    ...
    _cryptonight_hash(input.byteOffset, output.byteOffset, length, this.cryptonight_variant);
};
